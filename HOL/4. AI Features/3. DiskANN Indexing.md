...
> 
> Choosing the right value depends on your hardware (number of cores, available memory) and your workload priorities (faster index build vs. overall system responsiveness).
