...
1. In the **Object Explorer**, expand the `Databases` node under your SQL Server instance.
1. Right-click on the `Databases` node and select **New Database**.
1. In the **New Database** dialog, enter the database name `Movies`.
1. Press **OK** to create the database.
1. Press CTRL+N to open a new query window in SSMS.
...
## Step 2: Create and Populate the Movie Table
