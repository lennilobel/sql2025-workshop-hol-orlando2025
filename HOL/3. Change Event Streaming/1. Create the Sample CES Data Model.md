# Create the Sample CES Data Model

To get started, let's create a sample order processing data model. We will then use Change Event Streaming to track changes to orders, customers, and products in this database, and stream those changes to an Azure Event Hub.
