...
Replace the `<namespace-name>`, `<sas-token>`, and `<storage-connection-string>` placeholders with the **Event Hub Namespace Name**, **Event Hub SAS Token**, and **Storage Connection String** provided by your instructor.
