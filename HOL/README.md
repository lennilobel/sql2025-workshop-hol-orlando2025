...
Once connected, expand the **Databases** node in Object Explorer. You should see the **AdventureWorks2022** database, which is provided for use with the labs in this workshop.
